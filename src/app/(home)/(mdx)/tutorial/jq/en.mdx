...
export const metadata = {
  title: "How to Use jq?",
  keywords: "jq online, json formatter, json validator, jq playground, json query, jq cheatsheet, online jq tool, json parser, json viewer, jq filter, jq syntax, json processor, web-based jq, json manipulation, jq tester",
  description: "Powerful online tool to format, validate, query, and transform JSON data using jq syntax. A real-time jq playground for developers.",
};
