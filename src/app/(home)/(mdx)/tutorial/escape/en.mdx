...
export const metadata = {
  ...
  keywords: "JSON escape, JSON unescape, online JSON tool, json string escape, developer tools, escape special characters in JSON",
  description: "Easily escape and unescape JSON strings online. Our free tool helps you format JSON data for inclusion in strings or other contexts in one click.",
};
