...
export const metadata = {
  ...
  description: "An easy-to-use online tool to evaluate and test JSONPath expressions against your JSON data. Instantly validate and debug your JSON queries.",
};
