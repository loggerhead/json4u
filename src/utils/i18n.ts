...
const messages = {
  ...
  en: {
    ...
    showRightEditor: "Show right editor",
    autoFormat: "Auto format when paste",
    ignoreBlank: "Ignore blank diff",
    prev: "Previous",
    next: "Next",
    nodiff: "There is no difference between left and right",
    textCompared: "Do text compare instead",
    period: ". ",
