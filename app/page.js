...
function Page({loaded}) {
  ...
  const hideRightEditor = useSelector(hideRightEditorSelector);
      ...
      <div className="flex">
        <div
          ...
          className={`flex flex-col shrink min-w-fit relative gap-2 ${
            hideRightEditor === 0 ? "basis-1/2 md:basis-8/12" : hideRightEditor ? "basis-full" : "basis-1/2"
          }`}
        >
        ...
        <div className="flex flex-col gap-2">
          ...
          <Dragbar containerRef={leftContainerRef} className={hideRightEditor ? "hidden" : ""}></Dragbar>
        </div>
        <div className={`flex flex-col grow shrink min-w-fit gap-2 ${hideRightEditor ? "hidden" : ""}`}>
          <ul className="flex space-x-2 items-center">
            <li>
