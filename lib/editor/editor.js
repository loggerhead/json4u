...
export class EditorRef {
  ...
  urlToJSON() {
    ...
    this.call("urlToJSON", {text: this.text(), options}, (self, data) => {
  ...
  pythonDict2JSON() {
    ...
    this.call("pythonDict2JSON", {text: this.text(), options});
  }
  ...
  sort(order = "asc") {
    ...
    this.call("sort", {text: this.text(), options}, (self, data) => {
      const {text, errors} = data;
  ...
  compare(needTextCompare = false) {
    ...
    this.call("compare", {
      ...
      needTextCompare: needTextCompare,
    }, EditorRef.handleCompareResult);
  }
  ...
  onPaste(text = undefined) {
    ...
    const options = {
      nest: ctx(this.store).enableNestParse,
      format: ctx(this.store).enableAutoFormat,
      order: ctx(this.store).enableAutoSort ? "asc" : "",
    };
    ...
    this.call("handlePaste", {
      ...
      if (needShowRightEditor) {
        self.dispatch(showRightEditor());
      }
