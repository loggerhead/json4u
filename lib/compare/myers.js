import {DEL, Diff, HunkDiff, INS} from "./diff";
...
export function arrayDiff(lvals, rvals) {
  ...
  myersDiff(lchars, rchars, true).forEach((d) => {
...
export function myersDiff(a, b, isArrayDiff = false) {
  let lpos = 0;
  let rpos = 0;
  const diffs = diff(a, b, isArrayDiff);
